...
% Extract expDate from file name
% dateInd = regexp(fileNames{1}, '_201....._') + 1;
% expDateStr = fileNames{1}(dateInd:dateInd+7);
% expDate = datestr(datetime(expDateStr, 'InputFormat', 'yyyyMMdd'), 'yyyy_mm_dd');
