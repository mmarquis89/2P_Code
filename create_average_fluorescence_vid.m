function create_average_fluorescence_vid(parentDir, sids)
%===================================================================================================
...
for iSession = sids
    ...
    currSidFiles = fileNames(sessionNums == iSession);
    ...
    for iFile = 1:length(currSidFiles)
        ...
        if iFile == 1
            for iChannel = 1:nChannels
                ...
                fileName = ['Channel_', num2str(iChannel), '_sid_', num2str(iSession), '_average_fluorescence_by_trial'];
